...
pub const CL_MEM_READ_WRITE: cl_mem_flags = 1;
pub const CL_MEM_WRITE_ONLY: cl_mem_flags = 2;
pub const CL_MEM_READ_ONLY: cl_mem_flags = 4;
pub const CL_MEM_USE_HOST_PTR: cl_mem_flags = 8;
pub const CL_MEM_ALLOC_HOST_PTR: cl_mem_flags = 16;
pub const CL_MEM_COPY_HOST_PTR: cl_mem_flags = 32;
pub const CL_MEM_HOST_WRITE_ONLY: cl_mem_flags = 128;
pub const CL_MEM_HOST_READ_ONLY: cl_mem_flags = 256;
pub const CL_MEM_HOST_NO_ACCESS: cl_mem_flags = 512;
...
pub const CL_MEM_OBJECT_BUFFER: cl_mem_object_type = 4336;
pub const CL_MEM_OBJECT_IMAGE2D: cl_mem_object_type = 4337;
pub const CL_MEM_OBJECT_IMAGE3D: cl_mem_object_type = 4338;
pub const CL_MEM_OBJECT_IMAGE2D_ARRAY: cl_mem_object_type = 4339;
pub const CL_MEM_OBJECT_IMAGE1D: cl_mem_object_type = 4340;
pub const CL_MEM_OBJECT_IMAGE1D_ARRAY: cl_mem_object_type = 4341;
pub const CL_MEM_OBJECT_IMAGE1D_BUFFER: cl_mem_object_type = 4342;

pub const CL_MEM_TYPE: cl_mem_info = 4352;
pub const CL_MEM_FLAGS: cl_mem_info = 4353;
pub const CL_MEM_SIZE: cl_mem_info = 4354;
pub const CL_MEM_HOST_PTR: cl_mem_info = 4355;
pub const CL_MEM_MAP_COUNT: cl_mem_info = 4356;
pub const CL_MEM_REFERENCE_COUNT: cl_mem_info = 4357;
pub const CL_MEM_CONTEXT: cl_mem_info = 4358;
pub const CL_MEM_ASSOCIATED_MEMOBJECT: cl_mem_info = 4359;
pub const CL_MEM_OFFSET: cl_mem_info = 4360;
